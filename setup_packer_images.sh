...
# configs/virtual_ubuntu are symlinks to their counterparts in configs/stage3_ubuntu.
tar -hczf packer/virtual-files.tar.gz --owner root --group root -C configs/virtual_ubuntu .
