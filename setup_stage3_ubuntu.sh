...
if ! test -f $BOOTSTRAP/build.date ; then
    ...
    PACKAGES+="openssh-server,parted,pciutils,socat,sudo,systemd-resolved,systemd-sysv,"
    PACKAGES+="systemd-timesyncd,udev,unattended-upgrades,usbutils,vim,wget,xfsprogs"
